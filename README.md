.\" Ce fichier est formaté avec les macros -me.
.\" Compilez avec: groff -me -Tpdf README.me > README.pdf
.he ''Huffman Compression Project''%''
.sz 12
.tp
.sp 1i
.(l C
.sz 20
.b "Huffman Compression Project"
.sz 12
.)l
.sp 2
.uh "Description"
...
.uh "Key Features"
.ip \(bu 3
\fBHigh-Performance Core\fP: The compression and decompression algorithms (Min-Heap construction, Tree building, Bitwise I/O) are written in C.
.ip \(bu 3
\fBWeb Interface\fP: A clean, responsive UI built with React, TypeScript, and Tailwind CSS.
.ip \(bu 3
\fBREST API\fP: A Node.js/Express backend that handles file uploads and orchestrates the execution of the C binary.
.ip \(bu 3
\fBDockerized\fP: Fully containerized application ready for deployment (e.g., on Render).
.ip \(bu 3
\fBCLI Support\fP: The C program can also be used continuously as a standalone Command Line Interface tool.
.uh "Project Structure"
.pp
